...
const FinancesByFishingZones = ({table}) => {
    return (
        <div className={s.tableWrap}>
            <table className={s.financesByMonths}>
                <thead>
                    <tr>
                        <td>Зона</td>
                        <td>Выручка</td>
                ...
                <tbody>
                    {table?.fishingZones?.map((row) => (
                        <tr key={row.fishingZone.id}>
                            <td>{row.fishingZone.externalId}</td>
