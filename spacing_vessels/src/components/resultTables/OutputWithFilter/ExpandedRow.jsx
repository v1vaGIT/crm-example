        ...
        <>
            ...
            {isShowChildren &&
                row.products.map((item) => (
                    <tr key={item.product.id} className={s.childrenRow}>
                        <td className={s.secondNestedItem}>{item.product.name}</td>
                        {monthListEng.map((month) => (
                            <td key={month}>{item.months[month].toLocaleString('ru')}</td>
                        ))}
                        <td>{item.total.toLocaleString('ru')}</td>
                    </tr>
                ))}
        </>
    )
